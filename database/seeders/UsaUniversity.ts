...
export default class UsaUniversitySeeder extends BaseSeeder {
  public async run() {
    ...
    await University.createMany(
      [
        ...
        {
          name: 'Massachusetts College of Pharmacy and Health Sciences (MCPHS University)',
        },
        {
        ...
        {
          name: 'New York University - SPS',
        },
        {
          name: 'New England Instuite of Technology',
        },
        {
        ...
        {
          name: 'California State University, North Ridge',
        },
        {
        ...
        {
          name: 'Oklahoma State University, Still Water',
        },
        {
        ...
        {
          name: 'SUNY Polytechnic University',
        },
        {
          name: 'SUNY Brockport',
        },
        ...
        {
          name: 'University of Nebraska Kearny',
        },
        {
        ...
        {
          name: 'University of MaryHardin - Baylor',
        },
        {
        ...
        {
          name: 'University of Central Okhalama',
        },
        {
